import{x as h,y as o,z as e,A as p,C as t,D as n,E as m,G as f,H as d,J as F,K as v,L as E,M,N as u}from"./index.27e4d587.js";import{d as H,f as B,g as I,h as V}from"./index.5fd405d8.js";import{I as x}from"./Layout.8aa3e34b.js";import{at as i,cd as A}from"./index.e79d2d47.js";import{a as k}from"./index.d22a4f81.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function z(a){return i({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function U(a){return i({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const L={"dmg,ipa,plist,tipa":m,"exe,msi":f,"zip,gz,rar,7z,tar,jar,xz":d,apk:x,db:H,md:F,epub:B,iso:I,m3u8:t,"doc,docx":v,"xls,xlsx":E,"ppt,pptx":M,pdf:u,psd:z,ai:D,url:V,cast:k},Z=(a,c)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(L))if(s.split(",").includes(c.toLowerCase()))return r}switch(a){case l.FOLDER:return n;case l.VIDEO:return t;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},G=a=>Z(a.type,A(a.name));export{U as A,l as O,G as g};
