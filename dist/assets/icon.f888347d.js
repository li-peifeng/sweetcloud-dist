import{t as h,v as o,w as e,x as p,y as t,z as m,A as n,C as f,D as d,E as F,F as v,G as E,H as M,J as u}from"./index.769d4ff4.js";import{i as H,k as B,l as I,m as V}from"./index.f821bd57.js";import{I as x}from"./Layout.88e4cf70.js";import{am as i,cb as k}from"./index.476a32bf.js";import{a as A}from"./index.c60ec2d3.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function z(a){return i({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function U(a){return i({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const L={"dmg,ipa,plist,tipa":n,"exe,msi":f,"zip,gz,rar,7z,tar,jar,xz":d,apk:x,db:H,md:F,epub:B,iso:I,m3u8:t,"doc,docx":v,"xls,xlsx":E,"ppt,pptx":M,pdf:u,psd:z,ai:D,url:V,cast:A},Z=(a,c)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(L))if(s.split(",").includes(c.toLowerCase()))return r}switch(a){case l.FOLDER:return m;case l.VIDEO:return t;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},G=a=>Z(a.type,k(a.name));export{U as A,l as O,G as g};
